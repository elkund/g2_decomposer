...
for i = 1:n_start_peaks
    one_component_grid(start_peaks(i)-half_width:start_peaks(i)+half_width,1+i) = exp(half_width^2./(x.^2-(half_width+1)^2));%
    % one_component_grid(start_peaks(i)-half_width:start_peaks(i)+half_width,1+i)= 0.5;
end
